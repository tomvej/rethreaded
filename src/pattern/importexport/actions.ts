...
export const SWITCH_TEXT_EXPORT_DIALOG = `${FULL_NAME}/text-export-dialog` as 'text-export-dialog';
...
export interface SwitchTextExportDialogActionType {
    type: typeof SWITCH_TEXT_EXPORT_DIALOG;
    visible: boolean;
}
...
export const showTextExportDialog = (): SwitchTextExportDialogActionType => ({
    type: SWITCH_TEXT_EXPORT_DIALOG,
    visible: true,
});
export const hideTextExportDialog = (): SwitchTextExportDialogActionType => ({
    type: SWITCH_TEXT_EXPORT_DIALOG,
    visible: false,
});
...
export type ActionType = ParentActionType
    ...
    | SwitchTextExportDialogActionType
    | SetInfoActionType
