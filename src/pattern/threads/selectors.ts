...
export const getThreadNumberFromModel = (state: StateType): number => state.colors.length;
...
export const exportThreads: ExportThreads = (state: RootState) => getState(state).colors;
